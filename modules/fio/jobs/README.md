...
- `readwrite_latency.fio` - 4 latency-only jobs (read+write, iodepth=1, numjobs=1)
...
- `readonly_latency.fio` - 2 latency-only read jobs (for dm-verity/fs-verity latency)
...
stack. Each engine also has `_bandwidth` and `_latency` variants pointing to the corresponding files:

```
spdk.fio                             -> readwrite.fio
spdk_bandwidth.fio                   -> readwrite_bandwidth.fio
spdk_latency.fio                     -> readwrite_latency.fio

libaio.fio                           -> readwrite.fio
libaio_bandwidth.fio                 -> readwrite_bandwidth.fio
libaio_latency.fio                   -> readwrite_latency.fio

libaio-ext4.fio                      -> readwrite.fio
libaio-ext4_bandwidth.fio            -> readwrite_bandwidth.fio
libaio-ext4_latency.fio              -> readwrite_latency.fio
